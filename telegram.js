/**
 * @module telegram-notifications/telegram
 */

const WEBHOOK_URL = "https://api.telegram.org/bot";
...
Telegram.prototype.sendMessage = function(chatId, text) {
    ...
    if (!response.isSuccess) {
        workflow.message('Failed to post notification to Telegram. Details: ' + response.toString() + ' JSON: ' + JSON.stringify(payload));
    }
